...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-1.5 rounded-xl border border-border/60 bg-muted/30 py-2 pr-3 pl-3.5 text-sm whitespace-nowrap transition-all duration-200 outline-none select-none",
